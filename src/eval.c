...
int eval_board(Board *board) {
  ...
  for (int sq = 0; sq < 64; sq++) {
    ...
    if (color == WHITE) {
      ...
      case PAWN:
        position_weight   += POSITION_WHITE_PAWN[sq];
        break;
      case KNIGHT:
        position_weight += POSITION_WHITE_KNIGHT[sq];
        break;
      case BISHOP:
        position_weight += POSITION_WHITE_BISHOP[sq];
        break;
      case ROOK:
        position_weight   += POSITION_WHITE_ROOK[sq];
        break;
      case QUEEN:
        position_weight  += POSITION_WHITE_QUEEN[sq];
        break;
      case KING:
        position_weight   += POSITION_WHITE_KING[sq];
        break;
      default:
        break;
      }
      ...
      switch (PIECE(board->squares[sq])) {
      case PAWN:
        position_weight   -= POSITION_BLACK_PAWN[sq];
        break;
      case KNIGHT:
        position_weight -= POSITION_BLACK_KNIGHT[sq];
        break;
      case BISHOP:
        position_weight -= POSITION_BLACK_BISHOP[sq];
        break;
      case ROOK:
        position_weight   -= POSITION_BLACK_ROOK[sq];
        break;
      case QUEEN:
        position_weight  -= POSITION_BLACK_QUEEN[sq];
        break;
      case KING:
        position_weight   -= POSITION_BLACK_KING[sq];
        break;
      default:
        break;
      }
